...
public final class RequestParameterName {
	...
	public static final String USR_ADDRESS = "address";
	public static final String USR_BIRTHDAY = "birthday";
	public static final String USR_DOC_EXP_DATE = "expiration_date";
	public static final String USR_DOC_NUM = "passport";
	public static final String USR_DOC_ISSUE_DATE = "issue_date";
	public static final String USR_EMAIL = "email";
	public static final String USR_F_NAME = "first_name";
	public static final String USR_ID = "user_id";
	public static final String USR_ID_NUM = "identification_number";
	public static final String USR_L_NAME = "last_name";
